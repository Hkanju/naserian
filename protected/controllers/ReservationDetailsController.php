...
class ReservationDetailsController extends Controller
{
	 ...
	 * @return ReservationDetails the loaded model
	 ...
	 * @param ReservationDetails $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='reservation-details-form')
		{
